...
const EditBrand = (props) => {
    ...
    const handleSubmit = (event) => {
        ...
        if (correct) {
            ...
            const success = (data) => {
                // закриваємо модальне вікно створення-редагування
                setShow(false)
                // змінюємо стан родителя, щоб оновити список видавництв
    ...
    return (
        <Modal show={show} onHide={() => setShow(false)}>
            <Modal.Header closeButton>
                <Modal.Title>{id ? 'Редагування' : 'Створення'} видавництва</Modal.Title>
            </Modal.Header>
            <Modal.Body>
